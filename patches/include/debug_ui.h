...
DECLARE_FUNC(void, recomp_dbgui_set_next_item_width, f32 width);
DECLARE_FUNC(void, recomp_dbgui_push_item_width, f32 width);
DECLARE_FUNC(void, recomp_dbgui_pop_item_width);
DECLARE_FUNC(s32, recomp_dbgui_begin_tab_bar, const char *str_id);
DECLARE_FUNC(void, recomp_dbgui_end_tab_bar);
DECLARE_FUNC(s32, recomp_dbgui_begin_tab_item, const char *label, s32 *open);
DECLARE_FUNC(void, recomp_dbgui_end_tab_item);
